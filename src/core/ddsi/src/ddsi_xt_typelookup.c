...
{
  /* TypeLookup_Request */
  DDS_OP_ADR | DDS_OP_TYPE_EXT, offsetof (DDS_Builtin_TypeLookup_Request, header), (3u << 16u) + 7u /* RequestHeader */,
  DDS_OP_ADR | DDS_OP_TYPE_EXT, offsetof (DDS_Builtin_TypeLookup_Request, data), (3u << 16u) + 36u /* TypeLookup_Call */,
  DDS_OP_RTS,
  ...
  DDS_OP_ADR | DDS_OP_TYPE_EXT, offsetof (DDS_SampleIdentity, sequence_number), (3u << 16u) + 17u /* SequenceNumber */,
  DDS_OP_RTS,
  ...
  DDS_OP_ADR | DDS_OP_TYPE_4BY, offsetof (DDS_SequenceNumber, low),
  DDS_OP_RTS,
  ...
  DDS_OP_RTS,
  DDS_OP_ADR | DDS_OP_TYPE_SEQ | DDS_OP_SUBTYPE_UNI, offsetof (DDS_Builtin_TypeLookup_getTypeDependencies_In, type_ids), sizeof (DDS_XTypes_TypeIdentifier), (4u << 16u) + 65354u /* TypeIdentifier */,
  DDS_OP_RTS,
  DDS_OP_ADR | DDS_OP_TYPE_BSQ | DDS_OP_SUBTYPE_1BY, offsetof (DDS_Builtin_TypeLookup_getTypeDependencies_In, continuation_point), 32u,
  DDS_OP_RTS
};
...
const dds_topic_descriptor_t DDS_Builtin_TypeLookup_Request_desc =
{
  ...
  .m_keys = NULL,
  .m_nops = sizeof (DDS_Builtin_TypeLookup_Request_ops) / sizeof (DDS_Builtin_TypeLookup_Request_ops[0]),
...
const struct dds_cdrstream_desc DDS_Builtin_TypeLookup_Request_cdrstream_desc =
{
  ...
  .ops = {
    .nops = (uint32_t) (sizeof(DDS_Builtin_TypeLookup_Request_ops) / sizeof(DDS_Builtin_TypeLookup_Request_ops[0])),
...
static const uint32_t DDS_Builtin_TypeLookup_Reply_ops [] =
{
  ...
  DDS_OP_ADR | DDS_OP_TYPE_ENU | (2 << DDS_OP_FLAG_SZ_SHIFT) | DDS_OP_FLAG_TYPE_TC_DEF | DDS_OP_FLAG_TYPE_TC_TRIM, offsetof (DDS_RPC_ReplyHeader, remoteEx), 5u,
  DDS_OP_RTS,
  ...
  DDS_OP_RTS,
  DDS_OP_ADR | DDS_OP_TYPE_SEQ | DDS_OP_SUBTYPE_STU, offsetof (DDS_Builtin_TypeLookup_getTypes_Out, complete_to_minimal), sizeof (DDS_XTypes_TypeIdentifierPair), (4u << 16u) + 1039u /* TypeIdentifierPair */,
  DDS_OP_RTS,
  ...
  DDS_OP_ADR | DDS_OP_TYPE_EXT, offsetof (DDS_XTypes_TypeIdentifierTypeObjectPair, type_object), (3u << 16u) + 180u /* TypeObject */,
  DDS_OP_RTS,
  ...
  DDS_OP_JEQ4 | DDS_OP_TYPE_STU | 211 /* CompleteAnnotationType */, 80, offsetof (DDS_XTypes_CompleteTypeObject, _u.annotation_type), 0u,
  DDS_OP_JEQ4 | DDS_OP_TYPE_STU | 243 /* CompleteStructType */, 81, offsetof (DDS_XTypes_CompleteTypeObject, _u.struct_type), 0u,
  DDS_OP_JEQ4 | DDS_OP_TYPE_STU | 289 /* CompleteUnionType */, 82, offsetof (DDS_XTypes_CompleteTypeObject, _u.union_type), 0u,
  DDS_OP_JEQ4 | DDS_OP_TYPE_STU | 346 /* CompleteBitsetType */, 83, offsetof (DDS_XTypes_CompleteTypeObject, _u.bitset_type), 0u,
  DDS_OP_JEQ4 | DDS_OP_TYPE_STU | 379 /* CompleteSequenceType */, 96, offsetof (DDS_XTypes_CompleteTypeObject, _u.sequence_type), 0u,
  DDS_OP_JEQ4 | DDS_OP_TYPE_STU | 423 /* CompleteArrayType */, 97, offsetof (DDS_XTypes_CompleteTypeObject, _u.array_type), 0u,
  DDS_OP_JEQ4 | DDS_OP_TYPE_STU | 442 /* CompleteMapType */, 98, offsetof (DDS_XTypes_CompleteTypeObject, _u.map_type), 0u,
  DDS_OP_JEQ4 | DDS_OP_TYPE_STU | 452 /* CompleteEnumeratedType */, 64, offsetof (DDS_XTypes_CompleteTypeObject, _u.enumerated_type), 0u,
  DDS_OP_JEQ4 | DDS_OP_TYPE_STU | 487 /* CompleteBitmaskType */, 65, offsetof (DDS_XTypes_CompleteTypeObject, _u.bitmask_type), 0u,
  DDS_OP_JEQ4 | DDS_OP_TYPE_STU | 511 /* CompleteExtendedType */, 0, 0u, 0u,
  DDS_OP_RTS,
  ...
  DDS_OP_ADR | DDS_OP_TYPE_EXT, offsetof (DDS_XTypes_CompleteAliasType, body), (3u << 16u) + 128u /* CompleteAliasBody */,
  DDS_OP_RTS,
  ...
  DDS_OP_ADR | DDS_OP_FLAG_MU | DDS_OP_TYPE_UNI | DDS_OP_SUBTYPE_1BY | DDS_OP_FLAG_DEF, offsetof (DDS_XTypes_AnnotationParameterValue, _d), 16u, (72u << 16u) + 4u,
  ...
  DDS_OP_JEQ4 | DDS_OP_TYPE_1BY, 12, offsetof (DDS_XTypes_AnnotationParameterValue, _u.int8_value), 0u,
  DDS_OP_JEQ4 | DDS_OP_TYPE_1BY, 13, offsetof (DDS_XTypes_AnnotationParameterValue, _u.uint8_value), 0u,
  ...
  DDS_OP_ADR | DDS_OP_TYPE_EXT, offsetof (DDS_XTypes_CommonAliasBody, related_type), (3u << 16u) + 65145u /* TypeIdentifier */,
  DDS_OP_RTS,
  ...
  DDS_OP_ADR | DDS_OP_TYPE_EXT, offsetof (DDS_XTypes_CommonAnnotationParameter, member_type_id), (3u << 16u) + 65095u /* TypeIdentifier */,
  DDS_OP_RTS,
  ...
  DDS_OP_ADR | DDS_OP_TYPE_EXT, offsetof (DDS_XTypes_CommonStructMember, member_type_id), (3u << 16u) + 65057u /* TypeIdentifier */,
  DDS_OP_RTS,
  ...
  DDS_OP_ADR | DDS_OP_FLAG_OPT | DDS_OP_FLAG_EXT | DDS_OP_TYPE_SEQ | DDS_OP_SUBTYPE_STU, offsetof (DDS_XTypes_CompleteMemberDetail, ann_custom), sizeof (DDS_XTypes_AppliedAnnotation), (4u << 16u) + 65328u /* AppliedAnnotation */,
  DDS_OP_RTS,
  ...
  DDS_OP_ADR | DDS_OP_TYPE_EXT, offsetof (DDS_XTypes_CommonDiscriminatorMember, type_id), (3u << 16u) + 65004u /* TypeIdentifier */,
  DDS_OP_RTS,
  ...
  DDS_OP_ADR | DDS_OP_TYPE_EXT, offsetof (DDS_XTypes_CommonUnionMember, type_id), (3u << 16u) + 64986u /* TypeIdentifier */,
  ...
  DDS_OP_ADR | DDS_OP_TYPE_EXT, offsetof (DDS_XTypes_CommonCollectionElement, type), (3u << 16u) + 64908u /* TypeIdentifier */,
  DDS_OP_RTS,
  ...
  DDS_OP_ADR | DDS_OP_FLAG_OPT | DDS_OP_FLAG_EXT | DDS_OP_TYPE_SEQ | DDS_OP_SUBTYPE_STU, offsetof (DDS_XTypes_CompleteElementDetail, ann_custom), sizeof (DDS_XTypes_AppliedAnnotation), (4u << 16u) + 65182u /* AppliedAnnotation */,
  DDS_OP_RTS,
  ...
  /* TypeIdentifierPair */
  DDS_OP_ADR | DDS_OP_TYPE_EXT, offsetof (DDS_XTypes_TypeIdentifierPair, type_identifier1), (3u << 16u) + 64509u /* TypeIdentifier */,
  DDS_OP_ADR | DDS_OP_TYPE_EXT, offsetof (DDS_XTypes_TypeIdentifierPair, type_identifier2), (3u << 16u) + 64506u /* TypeIdentifier */,
  DDS_OP_RTS,
  ...
  DDS_OP_PLM | 8, 84468690u,
  DDS_OP_RTS,
  DDS_OP_ADR | DDS_OP_TYPE_SEQ | DDS_OP_SUBTYPE_STU, offsetof (DDS_Builtin_TypeLookup_getTypeDependencies_Out, dependent_typeids), sizeof (DDS_XTypes_TypeIdentifierWithSize), (4u << 16u) + 9u /* TypeIdentifierWithSize */,
  DDS_OP_RTS,
  DDS_OP_ADR | DDS_OP_TYPE_BSQ | DDS_OP_SUBTYPE_1BY, offsetof (DDS_Builtin_TypeLookup_getTypeDependencies_Out, continuation_point), 32u,
  DDS_OP_RTS,
...
const dds_topic_descriptor_t DDS_Builtin_TypeLookup_Reply_desc =
{
  ...
  .m_keys = NULL,
  .m_nops = sizeof (DDS_Builtin_TypeLookup_Reply_ops) / sizeof (DDS_Builtin_TypeLookup_Reply_ops[0]),
...
const struct dds_cdrstream_desc DDS_Builtin_TypeLookup_Reply_cdrstream_desc =
{
  ...
  .ops = {
    .nops = (uint32_t) (sizeof(DDS_Builtin_TypeLookup_Reply_ops) / sizeof(DDS_Builtin_TypeLookup_Reply_ops[0])),
